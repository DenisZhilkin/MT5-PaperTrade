//+------------------------------------------------------------------+
//|                                                     ListView.mqh |
//|                                          -->CPatchedListView.mqh |
//|                   Copyright 2009-2017, MetaQuotes Software Corp. |
//|                                              http://www.mql5.com |
//|                                                                  |
//|     NOTE: The most part of this file is code produced by         |
//|     MetaQuotes Software Corp.                                    |
//|     To provide correctness to my product - MT5-PaperTrade I had  |
//|     to make some changes to this file:                           |
...
//|                                                                  |
//|     TODO: Try to find more elegant way to solve this problem.    |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Class CPatchedListView                                           |
//| Usage: display lists                                             |
//+------------------------------------------------------------------+
class CPatchedListView : public CWndClient
  {
private:
   //--- dependent controls
...
//+------------------------------------------------------------------+
EVENT_MAP_BEGIN(CPatchedListView)
   ON_INDEXED_EVENT(ON_CLICK,m_rows,OnItemClick)
EVENT_MAP_END(CWndClient)
//+------------------------------------------------------------------+
//| Constructor                                                      |
//+------------------------------------------------------------------+
CPatchedListView::CPatchedListView(void) : m_offset(0),
                             m_total_view(0),
...
//| Destructor                                                       |
//+------------------------------------------------------------------+
CPatchedListView::~CPatchedListView(void)
  {
  }
//+------------------------------------------------------------------+
//| Create a control                                                 |
//+------------------------------------------------------------------+
bool CPatchedListView::Create(const long chart,const string name,const int subwin,const int x1,const int y1,const int x2,const int y2)
  {
   int y=y2;
...
//+------------------------------------------------------------------+
void CPatchedListView::Destroy(const int reason)
  {
...
//| Set parameter                                                    |
//+------------------------------------------------------------------+
bool CPatchedListView::TotalView(const int value)
  {
...
//+------------------------------------------------------------------+
bool CPatchedListView::Show(void)
  {
//--- call of the method of the parent class
   CWndClient::Show();
//--- number of items
...
//| Create "row"                                                     |
//+------------------------------------------------------------------+
bool CPatchedListView::CreateRow(const int index)
  {
...
//| Add item (row)                                                   |
//+------------------------------------------------------------------+
bool CPatchedListView::AddItem(const string item,const long value)
  {
...
//| Add item (row)                                                   |
//+------------------------------------------------------------------+
bool CPatchedListView::ItemAdd(const string item,const long value)
  {
//--- add
...
//| Insert item (row)                                                |
//+------------------------------------------------------------------+
bool CPatchedListView::ItemInsert(const int index,const string item,const long value)
  {
//--- insert
...
//| Update item (row)                                                |
//+------------------------------------------------------------------+
bool CPatchedListView::ItemUpdate(const int index,const string item,const long value)
  {
//--- update
...
//| Delete all items                                                 |
//+------------------------------------------------------------------+
bool CPatchedListView::ItemsClear(void)
  {
   m_offset=0;
//--- clear
...
//| Sett current item                                                |
//+------------------------------------------------------------------+
bool CPatchedListView::Select(const int index)
  {
//--- check index
...
//+------------------------------------------------------------------+
bool CPatchedListView::SelectByText(const string text)
  {
//--- find text
...
//+------------------------------------------------------------------+
bool CPatchedListView::SelectByValue(const long value)
  {
//--- find value
...
//| Redraw                                                           |
//+------------------------------------------------------------------+
bool CPatchedListView::Redraw(void)
  {
//--- loop by "rows"
   for(int i=0;i<m_total_view;i++)
     {
...
//| Change state                                                     |
//+------------------------------------------------------------------+
bool CPatchedListView::RowState(const int index,const bool select)
  {
//--- check index
...
//+------------------------------------------------------------------+
bool CPatchedListView::CheckView(void)
  {
//--- check visibility
...
//| Handler of resizing                                              |
//+------------------------------------------------------------------+
bool CPatchedListView::OnResize(void)
  {
//--- call of the method of the parent class
...
//+------------------------------------------------------------------+
bool CPatchedListView::OnVScrollShow(void)
  {
//--- loop by "rows"
   for(int i=0;i<m_total_view;i++)
     {
...
//+------------------------------------------------------------------+
bool CPatchedListView::OnVScrollHide(void)
  {
//--- check visibility
   if(!IS_VISIBLE)
      return(true);
...
//+------------------------------------------------------------------+
bool CPatchedListView::OnScrollLineUp(void)
  {
//--- get new offset
...
//+------------------------------------------------------------------+
bool CPatchedListView::OnScrollLineDown(void)
  {
//--- get new offset
   m_offset=m_scroll_v.CurrPos();
//--- redraw
...
//+------------------------------------------------------------------+
bool CPatchedListView::OnItemClick(const int index)
  {
//--- select "row"
